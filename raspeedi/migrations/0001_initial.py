    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media', models.CharField(choices=[('HDD', 'Disque Dur'), ('8Go', 'Carte SD 8Go'), ('16Go', 'Carte SD 16Go'), ('8Go 16Go', 'Carte SD 8 ou 16 Go')], max_length=20, null=True, verbose_name='type de média')),

...
urlpatterns = [
    ...
    path('corvet/export/csv/', views.export_corvet_csv, name='export_corvet_csv'),
    path('corvet/export/csv/bsi/', views.export_bsi_csv, name='export_bsi_csv'),
    path('corvet/export/csv/ecu/', views.export_ecu_csv, name='export_ecu_csv'),

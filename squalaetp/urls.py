...
urlpatterns = [
    ...
    path('xelon/prod/async/', ajax.xelon_prod_async, name='xelon_prod_async'),
    path('temporary/', views.temporary_table, name='temporary'),
    path('temporary/create/', views.TemporaryCreateView.as_view(), name='temporary_create'),
    path('temporary/<int:pk>/update/', views.TemporaryUpdateView.as_view(), name='temporary_update'),

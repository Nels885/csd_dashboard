...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('es_reference', models.CharField(blank=True, max_length=10, unique=True, verbose_name='référence EMS')),
                ('es_raw_reference', models.CharField(max_length=10, verbose_name='référence EMS brute')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reman_reference', models.CharField(max_length=10, verbose_name='référence REMAN')),
                ('psa_barcode', models.CharField(max_length=10, verbose_name='code barre PSA')),
                ('ecu_model', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reman.EcuModel')),
                ('spare_part', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='reman.SparePart')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',

...
urlpatterns = [
    ...
    path('part/<str:psa_barcode>/create/', views.create_part, name='part_create'),
    ...
    path('batch/<int:pk>/pdf/', views.batch_pdf_generate, name='batch_pdf'),
    ...
    path('batch/type/ajax/', views.batch_type_ajax, name='batch_type_ajax'),

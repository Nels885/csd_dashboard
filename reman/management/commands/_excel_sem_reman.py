...
class ExcelSemRefBase(ExcelFormat):
    ...
    COLS = {'A': 'brand', 'B': 'map_data', 'C': 'product_part', 'D': 'reman_reference', 'E': 'pf_code',
            'F': 'hw_reference', 'H': 'former_oe_reference', 'I': 'vehicle', 'K': 'barcode', 'L': 'oe_reference',
            'M': 'fan', 'N': 'rear_bolt', 'O': 'oe_raw_reference'}

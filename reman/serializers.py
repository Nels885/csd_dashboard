...
REPAIR_COLUMN_LIST = [
    'identify_number', 'batch__batch_number', 'batch__brand', 'batch__ecu_ref_base__ecu_type__technical_data',
...
class RemanRepairSerializer(serializers.ModelSerializer):
    ...
    brand = serializers.CharField(source='batch.brand', read_only=True)
    ...
    class Meta:
        model = Repair
        fields = (
            'id', 'identify_number', 'batch', 'brand', 'technical_data', 'supplier_oe', 'hw_reference', 'psa_barcode',

            ...
            data: {
                ...
                datasets: [
                    ...
                    },
                    {
                        ...
                        pointBorderColor: "rgba(255, 153, 204, 1)",
                    },
                    {
                        data: data['raspiSevenValue'],
                        label: "Raspeedi7",
                        lineTension: 0.3,
                        backgroundColor: "rgba(78, 115, 223, 0.05)",
                        borderColor: "rgba(204, 205, 0, 1)",
                        pointRadius: 2,
                        pointBackgroundColor: "rgba(204, 205, 0, 1)",
                        pointBorderColor: "rgba(204, 205, 0, 1)",
                    },
                    {
                        data: data['raspiEightValue'],
                        label: "Raspeedi8",
                        lineTension: 0.3,
                        backgroundColor: "rgba(78, 115, 223, 0.05)",
                        ...
                        pointBorderColor: "rgba(0, 102, 51, 1)",
                    },
                    {
                        data: data['raspiNineValue'],
                        label: "Raspeedi9",
                        lineTension: 0.3,
                        backgroundColor: "rgba(78, 115, 223, 0.05)",
                        ...
                        pointBorderColor: "rgba(102, 0, 204, 1)",
                    },
                ],
            },
            options: {

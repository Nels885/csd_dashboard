...
urlpatterns = [
    ...
    path('charts/ajax/', ajax.charts_async, name='charts_ajax'),
    ...
    path('search/ajax/', ajax.search_async, name="search_ajax"),
    path('email/send/', ajax.send_email_async, name="email_ajax"),
